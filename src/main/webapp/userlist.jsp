				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
												data-toggle="dropdown" role="button" aria-expanded="false">普通用户 [${sessionScope.name}]
							<span class="caret"></span>
						</a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="#">个人资料</a></li>
								<li class="divider"></li>
								<li><a href="${pageContext.request.contextPath}/tuichu.do
">安全退出</a></li>
							</ul></li>
					</ul>
				</div>
		...
		<div class="col-md-12">
			...
			<table  style="text-align:center" id="userPager"
				...
				<tr class="bg-danger" >
					...
					<td>${requestScope.u.source}</td>
					<td>${requestScope.u.ip}</td>
				</tr>
				</tbody>
